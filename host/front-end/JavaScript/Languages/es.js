let es = [
    ...
    ['/1vs2', '/1-vs-2'],
    ['/tournament', '/torneo'],
    ['/tournament-nicknames', '/torneo-pseudónimo'],
    ['/tournament-game', '/torneo-partido'],
    ['Tournament Game', 'Partido del torneo'],
    ['/tournament-leaderboard', '/torneo-clasificación'],
    ['Online Game', 'Online - Partido'],
    ["Tournament - Nicknames", "Torneo - Pseudónimos"],
    ['/customize', '/personalizar'],
    ['/statistics', '/estadísticas'],
    ['/game-history', '/partido-histórico'],
    ['Game History', 'Histórico del partido'],
    ['/local-stats', '/local-estadísticas'],
    ['/online-stats', '/online-estadísticas'],
    ['/settings', '/opciones'],
    ['/credits', '/créditos'],
    ['/privacy', '/privacidad'],
