...
// < display/remove > //
    ...
    displayOneVsOneGameOnline : function()
    {
        ...
        if (role == "host")
        {
            ...
            document.getElementById('h_versus_title').textContent = localStorage.getItem('login') + "  vs  " + localStorage.getItem('opponent_login');
            document.getElementById('waiting_host').style.display = "none";
        }
        else
        {
            document.getElementById('one_vs_one_guest_page').style.display = "block";
            document.getElementById('g_versus_title').textContent = localStorage.getItem('opponent_login') + "  vs  " + localStorage.getItem('login');
