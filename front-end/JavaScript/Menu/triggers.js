...
document.getElementById('high_contrast_btn_y').onclick = changeHighContrast;
document.getElementById('high_contrast_btn_n').onclick = changeHighContrast;
document.getElementById('image_desc_btn_y').onclick = changeDescriptiveImages;
document.getElementById('image_desc_btn_n').onclick = changeDescriptiveImages;